...
import { iUpdateContact, updateContactSchema } from "../../../pages/Dashboard/contactsSchema";
import { zodResolver } from "@hookform/resolvers/zod";
import { useContext } from "react"
import { ContactContext } from "../../../contexts/ContactContext";
 
export const ModalUpdateContact = () => {
    const { setOpenModalUpdateContact, onSubmitFormUpdateContact, contactUpdateOrDelete } = useContext(ContactContext);
